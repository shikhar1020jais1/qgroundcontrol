...
Rectangle {
    ...
    Rectangle {
        ...
        width: (altField.contentWidth + ScreenTools.defaultFontPixelWidth * 2 ) * 1.5
        radius: altField.contentHeight * 0.5
        height:         altField.contentHeight * 1.5
        color: qgcPal.window

        anchors.right: altSlider.left
        //anchors.bottom: parent.bottom
        //y: ( altSlider.height - (altSlider.height - Math.round(ScreenTools.defaultFontPixelHeight * 0.75))*altSlider.value )
        y:  altSlider.y + (altSlider.height - _margins) * (1-altSlider.value)
