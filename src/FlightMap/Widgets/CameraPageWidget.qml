...
Column {
    ...
    property bool   _streamingEnabled:      false //TODO: determine what it should be, VideoPageWidget.qml does QGroundControl.settingsManager.videoSettings(0).streamConfigured
    ...
    QGCButton {
        id: triggerCameraButton
        text:                       qsTr("Trigger Camera")
        visible:                    !_camera
        onClicked:                  activeVehicle.triggerSimpleCamera()
    ...
    Flickable {
        ...
        contentWidth: hLayout.implicitWidth
                    ...
                    Item {
                        ...
                        Rectangle {
                            ...
                            SequentialAnimation on height {
                                ...
                                running: false
                                PropertyAnimation {
                                    to: ScreenTools.defaultFontPixelHeight
                                    duration: 250
                                }
                                PropertyAnimation {
                                    to: ScreenTools.defaultFontPixelHeight * 2
                                    duration: 250
                                }
                            }
                        }
                        QGCColoredImage {
                            anchors.horizontalCenter: recordBtnBackground.horizontalCenter
                            anchors.verticalCenter: recordBtnBackground.verticalCenter
                            height: recordBtnBackground.height
                            width: height * 0.625
                            sourceSize.width: width
                            source: "qrc:/qmlimages/camera.svg"
                        ...
                        MouseArea {
                            ...
                            onClicked: {
                                ...
                                anim.start()
                                grabImageTimer.start()
                                QGroundControl.videoManager(index).grabImage()
                            }
                        }
                    }
                    QGCLabel {
            ...
            QGCFlickable {
                ...
                Column {
                    ...
                    Row {
                        spacing:            ScreenTools.defaultFontPixelWidth
                        anchors.horizontalCenter: parent.horizontalCenter
                        visible:            QGroundControl.videoManager(0).hasThermal
                    ...
                    Row {
                        spacing:            ScreenTools.defaultFontPixelWidth
                        anchors.horizontalCenter: parent.horizontalCenter
                        visible:            QGroundControl.videoManager(0).hasThermal && _camera.thermalMode === QGCCameraControl.THERMAL_BLEND
                        QGCLabel {
                    ...
                    Row {
                        ...
                        QGCSwitch {
                            ...
                            checked:            QGroundControl.settingsManager.videoSettings(0).gridLines.rawValue
                            width:              _editFieldWidth
                            anchors.verticalCenter: parent.verticalCenter
                            onClicked: {
                                if(checked) {
                                    QGroundControl.settingsManager.videoSettings(0).gridLines.rawValue = 1
                                } else {
                                    QGroundControl.settingsManager.videoSettings(0).gridLines.rawValue = 0
                                }
                            }
                        }
                    }
                    ...
                    Row {
                        ...
                        FactComboBox {
                            fact:               QGroundControl.settingsManager.videoSettings(0).videoFit
                            indexModel:         false
                            width:              _editFieldWidth
                            anchors.verticalCenter: parent.verticalCenter
                        }
