...
Drawer {
    ...
    background: Rectangle {
        color:                  qgcPal.globalTheme === QGCPalette.Light ? qgcPal.window : qgcPal.windowShadeDark
    }
    ...
    Item {
        ...
        Rectangle {
            ...
            color:                  qgcPal.globalTheme === QGCPalette.Light ? qgcPal.window : qgcPal.windowShade
            QGCLabel {
                x:                  _defaultTextWidth
                text:               dialogTitle
